...
def get_all_metrics(df: pd.DataFrame):
    ...
    asset_cgar = get_cgar(asset_ret_arr)
    asset_ref_beta = get_beta(asset_ret_arr, benchmark_ret_arr)
    asset_alpha = get_alpha(asset_ref_beta, asset_ret_arr, benchmark_ret_arr)


    print (asset_alpha)
    print (asset_ref_beta)
    print (asset_cgar)
    print (ann_asset_vol)
    print (asset_max_dd)
    print (asset_sharp)
